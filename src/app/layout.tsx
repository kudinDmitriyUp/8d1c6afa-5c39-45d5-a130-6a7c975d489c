...
export const metadata: Metadata = {
  title: "Xeven - Enterprise AI SaaS Platform",
  description: "Transform your business with intelligent AI solutions. Automate processes, gain insights, and scale faster with Xeven's enterprise-grade platform.",
  keywords: "AI SaaS, machine learning platform, business automation, enterprise AI, data analytics",
  metadataBase: new URL("https://xeven.io"),
  alternates: {
    canonical: "https://xeven.io"
  },
  openGraph: {
    title: "Xeven - Enterprise AI SaaS Platform",
    description: "Transform your business with intelligent AI solutions. Automate processes, gain insights, and scale faster.",
    type: "website",
    siteName: "Xeven",
    url: "https://xeven.io"
  },
